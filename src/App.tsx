      ...
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
        <div>
          ...
          <div className="flex items-center gap-4 mt-3">
            <a href="https://www.facebook.com/profile.php?id=61589579378260" target="_blank" rel="noopener noreferrer"
              className="text-slate-500 hover:text-[#C9A555] transition-colors" aria-label="Facebook">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073C0 18.1 4.388 23.094 10.125 24v-8.437H7.078v-3.49h3.047V9.41c0-3.025 1.792-4.697 4.533-4.697 1.312 0 2.686.236 2.686.236v2.97h-1.513c-1.491 0-1.956.93-1.956 1.884v2.25h3.328l-.532 3.49h-2.796V24C19.612 23.094 24 18.1 24 12.073z"/>
              </svg>
            </a>
            <a href="https://www.instagram.com/thehomecashbuyer/" target="_blank" rel="noopener noreferrer"
              className="text-slate-500 hover:text-[#C9A555] transition-colors" aria-label="Instagram">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://g.co/kgs/placeholder" target="_blank" rel="noopener noreferrer"
              className="text-slate-500 hover:text-[#C9A555] transition-colors" aria-label="Google Business Profile">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
